...
bool Sphere::rayIntersection(Ray &r){
	...
	Vertex o = r.getStart();		//Startpoint of ray
	Vertex e = r.getEnd();			//Endpoint of ray
	glm::vec3 l = glm::normalize(e-o);	//Direction Startpoint -> Endpoint
	...
	// The value of (d) for a ray point that is on the sphere surface is (dl + (o-c))*(dl + (o-c)) = r^2
